	    ...
	    <h1><?= ($page_head .'  '.$person['person_name'].'  '.$person['person_lname']) ?></h1>
            ...
            <form id="form1" action="task/edit" method="post" >              
	            ...
	            <div class="row">
    	            ...
    	            <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <div class="input-group input-group-sm mb-3">
                            <span class="input-group-text" id="inputGroup-sizing-sm"><strong><?= ($i18n_type) ?>:</strong></span>     		  
    		        ...
    		        <div class="col-12 col-md-6 col-lg-4 mb-3">
      		        ...
      		        <input type="text" class="form-control bg-primary bg-opacity-10" name="task_status" id="task_status"  value="<?= ($task['task_status']) ?>" required /> -->
                        <div class="input-group input-group-sm mb-3">
                            <span class="input-group-text" id="inputGroup-sizing-sm"><strong><?= ($i18n_status) ?>:</strong></span>      		  
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" id="simple-tab-2" data-bs-toggle="tab" href="#simple-tabpanel-2" role="tab" aria-controls="simple-tabpanel-2" aria-selected="true"><h4><?= ($i18n_notes) ?></h4>&nbsp;&nbsp;&nbsp;</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="simple-tab-3" data-bs-toggle="tab" href="#simple-tabpanel-3" role="tab" aria-controls="simple-tabpanel-3" aria-selected="false"><h4><?= ($i18n_images) ?></h4>&nbsp;&nbsp;&nbsp;</a>
  </li>
</ul>    
