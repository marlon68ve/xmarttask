...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" id="simple-tab-0" data-bs-toggle="tab" href="#simple-tabpanel-0" role="tab" aria-controls="simple-tabpanel-0" aria-selected="true">Persons&nbsp;&nbsp;
    <span class="badge inline pull-right text-bg-info"><?= ($pertasks_count) ?></span>
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="simple-tab-1" data-bs-toggle="tab" href="#simple-tabpanel-1" role="tab" aria-controls="simple-tabpanel-1" aria-selected="false">Project&nbsp;&nbsp;
    		...
    		<tr class="warning no-result">
    	     ...
    	     <tbody>
		        ...
		        <?php endif; ?> 
            		...
            		<td><?= ($getTaskStatusName($task['task_status'])) ?></td>
                 	<td>
			            <a href="<?= ($BASE.'/task/edit/'. $task['person_num'] . '/' . $task['task_num'] . '/person') ?>" title="<?= ($i18n_tasks) ?>"><i style = "color:orange; font-size: 10px;" class="bi bi-file-text-fill" data-toggle="tooltip"></i></a>
    		...
    		<tr class="warning no-result">
    	     ...
    	     <tbody>
		        ...
		        <?php endif; ?> 
            		...
            		<td><?= ($getTaskStatusName($protask['task_status'])) ?></td>
                 	<td>
